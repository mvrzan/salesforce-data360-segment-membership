...
const Header = () => (
  <header className="sticky top-0 z-50 border-b border-slate-800/60 bg-slate-950/70 backdrop-blur-xl">
    ...
    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-3">
      <Link to="/" className="group flex items-center gap-3 min-w-0 hover:opacity-90 transition-opacity">
        ...
        <div className="flex flex-col leading-tight min-w-0">
          <span className="text-white font-semibold text-[15px] tracking-tight truncate">Data 360 Segments</span>
          <span className="text-[11px] text-slate-500 tracking-wide truncate">Salesforce Data 360 explorer</span>
        </div>
      </Link>
